        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              ...
              <router-link to="/task" class="rounded-md px-3 py-2 text-sm bg-gray-900 font-medium text-white" aria-current="page">Task</router-link>
              <router-link to="/status" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Status</router-link>
            </div>
          </div>
        </div>
...
<!--        <a href="#" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Dashboard</a>-->
        <router-link to="/task" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Task</router-link>
